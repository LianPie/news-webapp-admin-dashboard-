...
namespace newsWebapp.Controllers
{
    public class NewsController : Controller
    {
        ...
        public ActionResult Create(NewsViewModel news, List<string> Tags, List<string> Cat)
        {
                ...
                if (Request.Files[0].ContentLength > 0)
                {
                    ...
                    if (news.title != null && news.link != null && Cat != null && Tags != null)
                    {
                        ...
                        var newsItem = new news 
                        {
                            ...
                            Content = news.Content, // This can be the raw HTML input
                            views = 0
                        };
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(NewsViewModel news, List<string> Tags, List<string> Cat)
        {
            if (ModelState.IsValid)
            {
                setLists();
